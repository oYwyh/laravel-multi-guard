...
unset($__errorArgs, $__bag); ?>
                    ...
                    <br>
                    <a href="<?php echo e(route('user.login')); ?>" class="mt-2">Alreay Have An Account</a>
                </form>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\hms\resources\views/dashboard/user/register.blade.php ENDPATH**/ ?>