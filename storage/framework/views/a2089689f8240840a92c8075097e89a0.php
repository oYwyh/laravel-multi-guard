...
unset($__errorArgs, $__bag); ?>
                    ...
                    <a href="<?php echo e(route('user.register')); ?>" class="mt-2">Don't Have An Account, Make One</a>
                </form>
            </div>
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\hms\resources\views/dashboard/user/login.blade.php ENDPATH**/ ?>