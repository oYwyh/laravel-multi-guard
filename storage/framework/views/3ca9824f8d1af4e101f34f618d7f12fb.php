            ...
            <div class="col-md-6 offset-md-3" style="margin-top: 45px">
                ...
                <table class="table table-striped table-inverse table-responsive">
                    <thead class="thead-inverse">
                        ...
                        <tbody>
                            <tr>
                                <td><?php echo e(Auth::guard('doctor')->user()->name); ?></td>
                                ...
                                <td>
                                    ...
                                    <form action="<?php echo e(route('doctor.logout')); ?>" method="post" class="d-none" id="logout-form"><?php echo csrf_field(); ?></form>
                                </td>
                            </tr>
                        </tbody>
                </table>
...
<?php /**PATH C:\xampp\htdocs\hms\resources\views/dashboard/doctor/home.blade.php ENDPATH**/ ?>