...
var Fp = {
  ...
  install: (e, t) => {
    ...
    t.suppress_compile_errors && (e.config.compilerOptions.onError = (n) => {
      import("./CompilerErrorMessages-4a55bbec-JKCUEWKL.js").then((i) => {
        console.error({
